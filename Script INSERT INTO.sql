INSERT INTO `Materiales` (`codigo`, `descripcion`, `unidad`,`precio`)
VALUES
    (100001,'Cemento', 'kg', 1000),
    (100002,'Estuco Blanco', 'm2', 1000),
    (100003,'Arena', 'und', 1000);


    (11, 107, 'Pratto'),
    (15, 1013, 'Reserva del Bosque'),
    (50, 1070, 'Alcabama');
...
INSERT INTO `Cuidad` (`idCuidad`, `nombreCuidad`, `estado`, `idDepartamento`)
VALUES
	(1,'Abriaquí',1,5),
	(2,'Acacías',1,50),
	(3,'Acandí',1,27),
...
INSERT INTO `Proyectos` (`Departamentos_idDepartamento`, `Cuidad_idCuidad`, `nombreProyecto`)
VALUES
